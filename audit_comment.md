...
- `[FALLBACK] (snapshot) ITA_UNEMPLOYMENT: declared primary ISTAT/151_874/M.IT.UNEM_R.N.1.Y15-74. (tier 0) demoted — stale 131d (last obs 2026-05-01, group freshest 2026-07-28, gate 2x31d); serving OECD/UNEMPLOYMENT (tier 1, Monthly, last 2026-07-28)`
- `[FALLBACK] ITA_UNEMPLOYMENT: declared primary ISTAT/151_874/M.IT.UNEM_R.N.1.Y15-74. (tier 0) demoted — stale 131d (last obs 2026-05-01, group freshest 2026-07-31, gate 2x31d); serving OECD/UNEMPLOYMENT (tier 1, Monthly, last 2026-07-31)`
...
|---|---|---|---|---|---|
| `CHN_PPI` | FRED | Monthly | 2022-12-01 | 1378d | 45d |
| `CHN_IND_PROD` | FRED | Monthly | 2023-11-01 | 1043d | 45d |
| `CHN_POLICY_RATE` | DB.nomics | Monthly | 2025-06-30 | 436d | 120d\* |
| `GBR_RATE_3M` | OECD | Monthly | 2026-02-28 | 193d | 90d\* |
| `JPN_IND_PROD` | e-Stat | Monthly | 2026-03-01 | 192d | 60d\* |
| `ITA_GDP_GROWTH` | ISTAT | Quarterly | 2026-03-01 | 192d | 90d\* |
...
| Series | Source | Frequency | Last obs | Age | Tolerance |
|---|---|---|---|---|---|
| `USA_CPI_YOY_ANNUAL` | World Bank | Annual | 2024-12-31 | 617d | 540d |
| `CHE_IND_PROD` | IMF SDMX | Quarterly | 2026-01-01 | 251d | 210d\* |
| `DEU_GDP_INDEX` | IMF SDMX | Quarterly | 2026-01-01 | 251d | 210d\* |
| `ITA_GDP_INDEX` | IMF SDMX | Quarterly | 2026-01-01 | 251d | 210d\* |
| `CHE_GDP_INDEX` | IMF SDMX | Quarterly | 2026-01-01 | 251d | 210d\* |
| `NLD_GDP_INDEX` | IMF SDMX | Quarterly | 2026-01-01 | 251d | 210d\* |
| `JP_TANKAN1` | BoJ | Quarterly | 2026-02-01 | 220d | 180d\* |
| `CHN_M2` | DB.nomics | Monthly | 2026-02-28 | 193d | 120d\* |
| `DEU_IND_PROD` | IMF SDMX | Monthly | 2026-03-01 | 192d | 150d\* |
| `EZ_EMPLOYMENT` | ECB | Quarterly | 2026-03-01 | 192d | 180d\* |
| `NLD_IND_PROD` | IMF SDMX | Monthly | 2026-03-01 | 192d | 150d\* |
| `USA_SP500_DIV_SHILLER` | Shiller | Monthly | 2026-03-31 | 162d | 90d\* |
| `USA_SP500_EPS_SHILLER` | Shiller | Monthly | 2026-03-31 | 162d | 90d\* |
| `USA_SP500_PE` | Shiller | Monthly | 2026-03-31 | 162d | 90d\* |
| `JPN_CORE_CPI_YOY` | DB.nomics | Monthly | 2026-04-30 | 132d | 90d\* |
| `JPN_CPI_YOY` | DB.nomics | Monthly | 2026-04-30 | 132d | 90d\* |
| `ITA_CPI_YOY` | DB.nomics | Monthly | 2026-04-30 | 132d | 90d\* |
| `CAN_CPI_YOY` | DB.nomics | Monthly | 2026-04-30 | 132d | 90d\* |
| `CHN_CON_CONF` | FRED | Monthly | 2026-05-01 | 131d | 90d\* |
| `CHN_BUS_CONF` | FRED | Monthly | 2026-05-01 | 131d | 75d\* |
| `EZ_BUILD_PERMITS` | Eurostat | Monthly | 2026-05-01 | 131d | 120d\* |
| `GBR_INFL_EXP_5Y` | BoE Survey | Quarterly | 2026-05-01 | 131d | 120d\* |
| `CHE_CPI_YOY` | DB.nomics | Monthly | 2026-05-31 | 101d | 90d\* |
| `NLD_CPI_YOY` | DB.nomics | Monthly | 2026-05-31 | 101d | 90d\* |
| `DEU_CPI_YOY` | DB.nomics | Monthly | 2026-05-31 | 101d | 90d\* |
| `USA_TREAS_10Y` | FRED | Monthly | 2026-06-01 | 100d | 75d\* |
| `USA_EQUITY_MEI` | FRED | Monthly | 2026-06-01 | 100d | 75d\* |
