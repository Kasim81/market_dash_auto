...
│   ├── ifo_probe.py                   # One-shot ifo workbook URL diagnostic — enumerates live gsk-*.xlsx paths from the ifo landing page; run via the ifo_probe workflow dispatch (157 lines)
...
│   └── build_review_workbook.py       # Generates docs/dropdown_review.xlsx — two-tab indicator cleanup and library review workbook for macro_indicator_library.csv (339 lines)
│
