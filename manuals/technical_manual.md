...
- `FLAG_primary_cadence_gap` — the tier-0 (national/primary) candidate is coarser-cadence than a tier-1 aggregator for the same column, i.e. a finer national source could exist but isn't registered. At last run: 1 (`FRA_UNEMPLOYMENT` — register a finer INSEE ticker).
