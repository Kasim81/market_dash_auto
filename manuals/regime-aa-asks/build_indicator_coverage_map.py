...
DATA = [
    ...
    # ---- 5.1.1 Forward-Looking / Anticipatory (Tier 1-2) ----
    {
        ...
        "regions": [
            ...
            {"region": "China", "analogue": "CGBs 10y-2y", "status": SOURCEABLE,
             "match": "", "psrc": "",
             "cand": "Monthly CN 10y free via OECD/FRED IRLTLT01CNM156N; 2y CGB leg and daily frequency remain hard", "notes": "DISCREPANCY vs spec: spec flags CN 10y as the canonical accepted gap, but a monthly CN 10y IS free (OECD MEI via FRED). The genuine gaps are the 2y CGB leg (no clean free source) and daily frequency. The slope is partially buildable at monthly frequency."},
        ],
    },
    {
    ...
    },
    {
        ...
        "regions": [
            ...
            {"region": "Eurozone", "analogue": "EZ M3", "status": SOURCEABLE,
             "match": "", "psrc": "", "cand": "ECB BSI M3 (SDW) - free", "notes": "Not in pipeline; ECB M3 free via SDW / FRED MABMM301EZM189S."},
            {"region": "Japan", "analogue": "JP M2", "status": SOURCEABLE,
             "match": "", "psrc": "", "cand": "BoJ M2 / FRED MYAGM2JPM189S - free", "notes": "Not in pipeline; BoJ M2 freely available."},
    ...
    },
    {
        ...
        "regions": [
            {"region": "US", "analogue": "NAHB HMI", "status": SOURCEABLE,
             "match": "PERMIT; US_HOUS1; US_R6 (related)", "psrc": "FRED",
             "cand": "FRED NAHBSHF (NAHB/Wells Fargo HMI, monthly) - free", "notes": "HMI itself IS free on FRED (NAHBSHF); not yet fetched. Pipeline currently uses building permits and mortgage-spread as housing-cycle proxies."},
    ...
    },
    {
        ...
        "regions": [
            ...
            {"region": "UK", "analogue": "ONS housing permits / starts", "status": SOURCEABLE,
             "match": "", "psrc": "", "cand": "MHCLG/ONS dwelling starts - free", "notes": "Not in pipeline; UK new-build starts published free by MHCLG/ONS."},
    ...
    },
    {
        ...
        "regions": [
            ...
            {"region": "UK", "analogue": "ONS Claimant Count", "status": SOURCEABLE,
             "match": "UK Unemployment Rate (related)", "psrc": "ONS", "cand": "ONS Claimant Count - free (monthly)", "notes": "Claimant count not in pipeline; ONS publishes free (monthly, not weekly)."},
    ...
    # ---- 5.1.3 Coincident Real-Time Gauges (Tier 3-4) ----
    {
        ...
        "regions": [
            ...
            {"region": "UK", "analogue": "ONS payrolled employees", "status": SOURCEABLE,
             "match": "UK Employment Rate (related)", "psrc": "ONS", "cand": "ONS HMRC PAYE payrolls - free", "notes": "Payroll change not in pipeline; ONS PAYE RTI free (monthly)."},
    ...
    },
    {
        ...
        "regions": [
            {"region": "US", "analogue": "Cleveland Median / Trimmed-Mean CPI", "status": SOURCEABLE,
             "match": "", "psrc": "", "cand": "FRED MEDCPIM158SFRBCLE (Median), TRMMEANCPIM158SFRBCLE (16% Trimmed Mean), PCETRIM12M159SFRBDAL (Dallas Trimmed PCE) - free", "notes": "Free on FRED (Cleveland / Dallas Fed); not in pipeline. No regional analogue (spec: none)."},
        ],
    },
    {
        ...
        "regions": [
            ...
            {"region": "UK", "analogue": "ONS PPI", "status": SOURCEABLE, "match": "", "psrc": "", "cand": "ONS PPI output/input - free", "notes": "Not in pipeline; ONS PPI free."},
    ...
    },
    {
        ...
        "regions": [
            {"region": "US", "analogue": "UMich 5-10y inflation expectations", "status": SOURCEABLE,
             "match": "MICH (1y, in pipeline)", "psrc": "FRED", "cand": "FRED MICH5YR (5-10y) - free", "notes": "1y expectations (MICH) in pipeline; the 5-10y long-run measure is free on FRED as MICH5YR (spot-check id before fetch)."},
