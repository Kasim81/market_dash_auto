...
- ✅ **Label-vs-data audit reconciliation (PR #225, commit `65d42df`, 2026-06-18):** `manuals/2026-06-15-label-vs-data-audit.md` cross-checked against live pipeline. All 15 market CRITICALs and 19/22 macro CRITICALs resolved. 3 remaining open macro CRITICALs are credential-gated: 3× e-Stat Japan series need `ESTAT_APP_ID`, 3× BLS series need `BLS_API_KEY`.
