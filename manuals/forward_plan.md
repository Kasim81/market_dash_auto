...
- ⏳ **GDP Now (§3.1.4)** — `US_GDPNOW1` + `US_NOWCAST1` via Atlanta Fed / NY Fed; `UK_NOWCAST1` via ONS monthly GDP; `EU_NOWCAST1` Phase E composite **shipped 2026-06-11** (equal-weight z of EZ IP / retail / ESI / industrial confidence); `JP_NOWCAST1` Phase E composite still outstanding (will follow same shape once Stage C JP growth e-Stat rows resolve their statsDataIds + cdCat filters).
